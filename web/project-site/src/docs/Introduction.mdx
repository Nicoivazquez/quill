...
Quill is a robust, open-source, and completely offline audio transcription application designed for self-hosters who value privacy and performance.

<div className="relative isolate mt-10 mb-32">
    <div className="relative">
         <BrowserFrame className="max-w-[90%] md:max-w-[75%]">
            <img src="/screenshots/homepage-light.png" alt="Quill Desktop View" className="w-full" />
         </BrowserFrame>
    </div>
    ...
    <div className="absolute top-1/2 right-0 transform -translate-y-1/3 md:translate-x-0 hidden sm:block">
         <PhoneFrame className="shadow-2xl">
            <img src="/screenshots/mobile-homepage-light.PNG" alt="Quill Mobile View" className="w-full h-full object-cover" />
         </PhoneFrame>
    </div>
</div>
...
- **Smart Speaker Detection**: It doesn’t just output a block of text—Quill automatically detects different speakers (Diarization) and labels exactly who said what.
...
- **Built for your Workflow**: With extensive APIs and a clever "File Watcher" that automatically processes new files in a folder, Quill fits right into your existing automations (like n8n).
...
The inspiration for Quill was born out of privacy paranoia not wanting to pay for subscription.
