...
Quill uses [pyannote.audio](https://github.com/pyannote/pyannote-audio) for speaker diarization. To use this feature, you need to obtain an access token from Hugging Face.
...
**Option B: UI Input**
Enter the token directly in the Quill UI under Transcription Profile settings when configuring diarization.
...
After setting up the token, you can enable Speaker Diarization in your Transcription Profiles or Advanced settings within Quill.
