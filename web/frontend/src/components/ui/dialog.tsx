  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-[calc(100%-2rem)] min-w-0 max-w-lg max-h-[calc(100dvh-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[var(--radius-card)] p-6 shadow-[var(--shadow-float)] duration-200 bg-[var(--bg-card)] border border-[var(--border-subtle)] overflow-x-hidden overflow-y-auto",
          className
        )}
        {...props}
      >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("min-w-0 text-lg leading-none font-bold", className)}
      {...props}
    />
  )
}
