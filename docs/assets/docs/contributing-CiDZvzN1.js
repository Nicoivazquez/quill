...
# Run the server
./quill`})})]}),e.jsxs("section",{children:[e.jsx("h2",{children:"Testing"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-4 font-mono text-sm mt-2 overflow-x-auto",children:e.jsx("pre",{children:`# Run all Go tests with verbose output
go test ./... -v
